...
public class MainController extends HttpServlet {
    ...
    private static final String SEARCH_ATAD = "SearchAtAD";
    private static final String SEARCH_ATAD_CONTROLLER = "SearchAtADController";
    ...
    private static final String SHOW = "Search";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            } else if (SEARCH_ATAD.equals(action)) {
                url = SEARCH_ATAD_CONTROLLER;
